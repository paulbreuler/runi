...
describe('CommandBar', () => {
  ...
  it('renders URL input with proper placeholder', () => {
    render(<CommandBar {...defaultProps} url="" />);
  ...
  it('applies muted composite focus state on command bar', () => {
    render(<CommandBar {...defaultProps} url="" />);
    const control = screen.getByTestId('command-bar');
  ...
  it('shows loading state on send button', () => {
    render(<CommandBar {...defaultProps} loading={true} />);
  ...
  it('enables send button when URL is valid', () => {
    render(<CommandBar {...defaultProps} url="https://api.example.com" />);
  ...
  it('does not call onSend on Enter when URL is empty', async () => {
    const onSend = vi.fn();
    render(<CommandBar {...defaultProps} url="" onSend={onSend} />);
  ...
  it('calls onUrlChange when typing in URL input', async () => {
    ...
    render(<CommandBar {...defaultProps} url="" onUrlChange={onUrlChange} />);
