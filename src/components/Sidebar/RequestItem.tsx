...
/**
 * RequestItem - A simplified sidebar item for API requests.
    ...
    >
      <div className={cn('relative w-full px-1', className)}>
        <div
          ...
          className={cn(
            'w-full flex items-center justify-between gap-2 px-2 py-1 text-left transition-colors cursor-pointer rounded-md',
