...
describe('EmptyState', () => {
  ...
  it('renders icon when provided and not muted', () => {
    const icon = <span data-test-id="test-icon">Icon</span>;
  ...
  it('renders action when provided', () => {
    const action = <button data-test-id="action-button">Action</button>;
  ...
  describe('variant prop', () => {
    ...
    it('renders prominent variant with icon', () => {
      const icon = <Key data-test-id="test-icon" />;
    ...
    it('renders children alongside title and description', () => {
      render(
        <EmptyState title="Title" description="Description">
          <button data-test-id="custom-action">Custom Action</button>
        </EmptyState>
      );
  ...
  describe('icon variants', () => {
    it('renders icon with correct size in prominent variant', () => {
      const icon = <Key data-test-id="test-icon" />;
      const { container } = render(<EmptyState title="Title" icon={icon} variant="prominent" />);
      const iconContainer = container.querySelector('[data-test-id="test-icon"]')?.parentElement;
