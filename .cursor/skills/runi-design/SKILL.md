...
See `docs/DESIGN_IDEOLOGY.md` for the complete craftsmanship philosophy, custom component library approach, and unified material feel principles.
...
- **Design Ideology**: `docs/DESIGN_IDEOLOGY.md` - Craftsmanship philosophy, custom component library approach, Unreal Engine metaphor
