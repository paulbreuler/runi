...
| 2026-01-12 | Claude commands for AI support | `/test`, `/scaffold`, `/pr-create`, `/prime` commands accelerate solo maintainer workflow | [awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)                                |
